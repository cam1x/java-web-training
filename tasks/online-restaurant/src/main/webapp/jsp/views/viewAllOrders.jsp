        ...
        <c:when test="${not empty orders}">
            <div class="mdl-cell mdl-cell--8-col">
                <h1 class="block-header">
                    <fmt:message key="table.allOrders"/>
                </h1>
                <table class="mdl-data-table mdl-js-data-table">
                    <thead>
                    <tr>
                        <th class="mdl-data-table__cell--non-numeric">
                            <fmt:message key="order.customerId"/>
                        </th>
                        <th class="mdl-data-table__cell--non-numeric">
                        ...
                        <tr>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">
                                <form action="${pageContext.request.contextPath}/" method="POST">
                                    ...
                                    <input type="hidden" name="commandName" value="prevStatus"/>
                                    <input class="mdl-button mdl-js-button" type="submit"
                                           value="<fmt:message key="order.prevStatus"/>"/>
                                </form>
                            </td>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">
                                <form action="${pageContext.request.contextPath}/" method="POST">
                                    <input type="hidden" name="orderId" value="${_order.id}"/>
                                    <input type="hidden" name="commandName" value="nextStatus"/>
                                    <input class="mdl-button mdl-js-button" type="submit"
                                           value="<fmt:message key="order.nextStatus"/>"/>
                                </form>
                            </td>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">
                                <form action="${pageContext.request.contextPath}/" method="GET">
                                    <input type="hidden" name="orderId" value="${_order.id}"/>
                                    <input type="hidden" name="commandName" value="orderDetails"/>
                                    <input class="mdl-button mdl-js-button" type="submit"
                                           value="<fmt:message key="table.orderDetails"/>"/>
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
