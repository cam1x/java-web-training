...
<jsp:directive.attribute name="_wallet" type="by.training.wallet.WalletDto" required="true"
...
<dialog class="mdl-dialog">
    <h4 class="mdl-dialog__title">
        <fmt:message key="dialog.editWalletTittle"/>
    </h4>
    <div class="mdl-dialog__content">
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input:input fieldName="name" beanName="wallet" value="${_wallet.name}"
                         _pattern="[a-zA-Zа-яА-Я\s\-]+" _patternNotMatchingMsg="onlyLetters"/>
        </div>
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input:input fieldName="deposit" beanName="wallet"
